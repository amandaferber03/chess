...
namespace Chess
{
    ...
    // Checks if the game is valid
	  ...
	  bool legal_move_path(const Position& start, const Position& end, bool check_exposed) const;
		...
		void make_move(const Position& start, const Position& end, bool is_real_game);
